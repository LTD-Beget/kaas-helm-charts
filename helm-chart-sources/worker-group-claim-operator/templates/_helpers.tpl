...
*/}}
{{- define "worker-group-claim-operator.name" -}}
...
*/}}
{{- define "worker-group-claim-operator.fullname" -}}
...
*/}}
{{- define "worker-group-claim-operator.namespaceName" -}}
{{- .Release.Namespace }}
{{- end }}
...
*/}}
{{- define "worker-group-claim-operator.resourceName" -}}
{{- $fullname := include "worker-group-claim-operator.fullname" .context }}
{{- $suffix := .suffix }}
