...
- name: {{ $containerName }}
  ...
  {{- if $containerValue.livenessProbeEnabled }}
  ...
  {{- if $containerValue.readinessProbeEnabled }}
  ...
  {{- if $containerValue.startupProbeEnabled }}
  {{- with $containerValue.extraStartupProbe }}
  startupProbe:
    {{- toYaml . | nindent 4 }}
  {{- end }}
  {{- end }}
