...
*/}}
{{- define "cluster-claim-operator.name" -}}
...
*/}}
{{- define "cluster-claim-operator.fullname" -}}
...
*/}}
{{- define "cluster-claim-operator.namespaceName" -}}
{{- .Release.Namespace }}
{{- end }}
...
*/}}
{{- define "cluster-claim-operator.resourceName" -}}
{{- $fullname := include "cluster-claim-operator.fullname" .context }}
{{- $suffix := .suffix }}
